...
local resourceName = 'ShowID' -- The name of your FiveM resource
...
local githubVersionFilename = 'showid-version.txt' -- The filename on GitHub containing the version information
